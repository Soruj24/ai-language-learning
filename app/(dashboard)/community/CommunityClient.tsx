              ...
              {posts.map((post) => (
                <Card key={post._id}>
                  ...
                  <CardFooter className="flex gap-4">
                    ...
                    >
                      <ThumbsUp className="mr-2 h-4 w-4" /> {post.upvoteCount}{" "}
                      {t("upvote")}
                    </Button>
                ...
                <Card key={group._id}>
                  ...
                  <CardFooter>
                    <Button className="w-full" variant="outline">
                      <Users className="mr-2 h-4 w-4" /> {t("joinGroup")}
                    </Button>
                  </CardFooter>
                </Card>
              ))}
          ...
          <Card>
            ...
            <CardContent className="space-y-4">
              ...
              <Button
                ...
                disabled={
                  !correctionOriginal.trim() || !correctionCorrected.trim()
                }
              >
                {t("submitCorrection")}
              </Button>
                ...
                <Card key={correction._id}>
                  <CardHeader>
                    <CardTitle className="text-sm font-medium">
                      {t("postedBy")} {correction.authorName}
                    </CardTitle>
                  ...
                  <CardFooter>
                    <Button
                      variant="ghost"
                      size="sm"
                      onClick={() => handleUpvote(correction._id)}
                    >
                      <ThumbsUp className="mr-2 h-4 w-4" />{" "}
                      {correction.upvoteCount} {t("upvote")}
                    </Button>
                  </CardFooter>
                </Card>
              ))}
              ...
              {posts.map((resource) => (
                <Card key={resource._id}>
                  <CardHeader>
                    ...
                    <CardDescription>
                      {t("postedBy")} {resource.authorName}
                    </CardDescription>
                  </CardHeader>
                  <CardContent>
                    <a
